...
while iu0(2) < iend
    ...
    crgsurf.ct{1}  = sprintf('demo segment generated by %s at %s', mfilename, char(datetime("now", Format="yyyy-MM-dd HH:mm:ss")));
...
crgsurf.ct{1}  = sprintf('demo surface generated by %s at %s', mfilename, char(datetime("now", Format="yyyy-MM-dd HH:mm:ss")));
crg_write(crgsurf, crgsurf.filenm);
