...
runtime = struct( ...
    ...
    "TirePlaneSFunctionName", "crg_sfun_tire_plane", ...
    "TirePlaneBlockHelper", "crg_add_tire_plane_block", ...
    "TirePlaneReplaceHelper", "crg_replace_tire_plane_block", ...
    "CodegenFunction", "crg_runtime_xy2z_file", ...
    "Outputs", ["u", "v", "z", "phi", "curvature", "status"], ...
    "TirePlaneInputs", ["x", "y", "pz_prev", "x_prev", "y_prev", "iu_prev"], ...
    "TirePlaneOutputs", ["px", "py", "pz", "iu_curr", "qx", "qy", "qz"], ...
    "Lookup", lookup, ...
